...
def d3pg_tuning(env, dic = {'n_episodes': 1000,
       'max_t': 300,
       'actor_fc1_units': 400,
       'actor_fc2_units': 300,
       ...
       'epsilon': 0.3,
       'file': 'chpt',
       }, SuccessStop=True, agent_name="final_d3pg"):
    ...
    agent.actor_local.load_state_dict(torch.load('chpt_'+agent_name+'_actor.pth'))
    agent.critic_local.load_state_dict(torch.load('chpt_'+agent_name+'_critic.pth'))
