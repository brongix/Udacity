...
def d3pg(env, dic = {'n_episodes': 1000,
    ...
    agent = Agent(num_agents=num_agents, state_size=state_size, action_size=action_size, hyper_dic=dic, PER=PER)
    ...
    for i_episode in range(1, n_episodes+1):
        ...
        for t in range(max_t):
            actions = agent.act(states, add_noise=True, episode=i_episode, NoiseNet=NoiseNet)
