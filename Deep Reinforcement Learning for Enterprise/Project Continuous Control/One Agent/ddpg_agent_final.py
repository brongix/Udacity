...
from model_ddpg_final import Actor, Critic
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed=0, hyper_dic = {'actor_fc1_units': 400,
                                                             'actor_fc2_units': 300,
        ...
        # Noise process
        self.noise = OUNoise(action_size, theta=hyper_dic['noise_theta'], sigma=hyper_dic['noise_sigma'])
    ...
    def act(self, state, add_noise=True, episode=None):
        ...
        if add_noise:
            action += (.5)**(episode/500)*self.noise.sample()
